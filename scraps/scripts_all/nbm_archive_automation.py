...
if __name__ == '__main__':
    ...
    try:
        with xr.open_dataset(sorted([f for f in nbm_agg if 'f096' in f])[-1]) as sample:
    ...
    dl_script = '/uufs/chpc.utah.edu/common/home/u1070830/code/nbm-streamline/scripts/get_nbm_gribs_aws.py ' 
    ...
    for forecast_hour in np.arange(24, 96+1, 24):
